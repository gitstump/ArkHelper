...
| `unofficial_store.js` | Separate SQLite (`unofficial.sqlite`) — latest trimmed fields + first_seen/last_seen/cycles_seen + transfer flags; `server_mods` / `mods` for CurseForge-backed adoption |
